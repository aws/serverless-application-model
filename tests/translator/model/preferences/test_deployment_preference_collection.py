...
class TestDeploymentPreferenceCollection(TestCase):
    ...
    def global_deployment_preference_yaml_dict(self):
        ...
        deployment_preference_yaml_dict['Hooks'] = {'PreTraffic': self.pre_traffic_hook_global,
    ...
    def global_deployment_preference(self):
        expected_deployment_preference = DeploymentPreference(self.deployment_type_global,
                                                              self.pre_traffic_hook_global,
                                                              self.post_traffic_host_global, self.alarms_global, True)
