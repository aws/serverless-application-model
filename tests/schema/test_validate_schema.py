...
class TestValidateUnifiedSchema(TestCase):
    ...
    def test_structure(self):
        ...
        assert (
            ...
            in UNIFIED_SCHEMA["definitions"]["samtranslator__schema_source__aws_serverless_statemachine__ApiEvent"]["properties"][
                "Properties"
            ]["markdownDescription"]
        )
        ...
        del sam_defs["samtranslator__schema_source__any_cfn_resource__Resource"]
        ...
        for v in SCHEMA["properties"]["Resources"]["additionalProperties"]["anyOf"]:
            if v["$ref"] != "#/definitions/samtranslator__schema_source__any_cfn_resource__Resource":
