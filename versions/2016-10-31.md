...
AutoPublishAlias | `string` | Name of the Alias. Read [AutoPublishAlias Guide](docs/guide/safe-lambda-deployments.rst#instant-traffic-shifting-using-lambda-aliases) for how it works
