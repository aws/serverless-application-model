...
Cors:
  ...
  ExposeHeaders: Optional. String of headers that can be exposed.
  # For example, "'Content-Length,X-Revision'". Checkout [HTTP Spec](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Expose-Headers) for more details on this value.
