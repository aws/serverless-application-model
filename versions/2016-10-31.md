...
EventInvokeConfig | [EventInvokeConfig object](#event-invoke-config-object) | Configure event destinations and retry behaviour on asynchronous invokes.
...
DestinationConfig | [Desitnation Config Object](#event-invoke-destination-config-object) | A destination for events after they have been sent to a function for processing. Optional parameter.
...
Property Name | Type | Description
---|:---:|---
OnSuccess | `object` | Takes Type of resource and Destination for events that succeeded processing.
OnFailure | `object` | Takes Type of resource and Destination for events that failed processing.
