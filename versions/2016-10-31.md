...
Logs | `map` <span>&#124;</span> [FunctionLogs_Object](#functionlogs-object) | Configures the Log Group of the function
...
#### FunctionLogs Object
Defines the log group configuration for the function. Creates a "AWS::Logs::LogGroup" resource. Cannot be added to an existing function (after an invocation of the lambda function, AWS Lambda will create a LogGroup for the function).

Syntax:
```
Logs:
  RententionInDays: int
```
