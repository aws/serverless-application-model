...
The object describing an event source with type `CodeCommit`.

##### Properties

Property Name | Type | Description
---|:---:|---
RepositoryName | `string` | **Required.** Name of CodeCommit Repository.

##### Example: CodeCommit source object
