...
OpenApiVersion | `string` | Version of OpenApi to use in the generated swagger. This can either be `'2.0'` for the swagger spec or one of the OpenApi 3.0 versions, like `'3.0.1'`.
