...
### Resource types
 ...
 - [AWS::Serverless::GraphQLApi](#awsserverlessgraphqlapi)
...
Creates a AppSync API with log role, and API keys.

Property Name | Type | Description
---|:---:|---
Name | `string` | **Required** The API name.
AuthenticationType | `string` | **Required** Security configuration for your GraphQL API. For allowed values (such as `API_KEY`, `AWS_IAM`, or `AMAZON_COGNITO_USER_POOLS`, `OPENID_CONNECT`), see [Security](https://docs.aws.amazon.com/appsync/latest/devguide/security.html) in the AWS AppSync Developer Guide.
SchemaDefinition | `string` | A `string` representing the GraphQL Schema
SchemaDefinitionUri | `string` | A S3 uri pointing to the location of a Graphql Schema.
LogConfig | [Graph Log Config Object](#graph-log-config-object) | Specifies the settings to enable logging for the Api.
OpenIDConnectConfig | [OpenIDConnect Config Object](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-openidconnectconfig.html) | Specifies the settings to configure `OPENID_CONNECT` AuthenticationType.
UserPoolConfig | [UserPool Config Object](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-userpoolconfig.html) | Specifies the settings to configure `AMAZON_COGNITO_USER_POOLS` AuthenticationType.
ApiKeys | [[Graph Api Key Object](#graph-api-key-object)] \| `null` | Specifies a list of api keys to create for the Api.

##### Return values

###### Ref
When the logical ID of this resource is provided to the [Ref](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-ref.html) intrinsic function, it returns the resource ARN of the underlying AppSync GraphQLApi
...
GraphQLUrl | The Endpoint provided by of the Api.

##### Example: AWS::Serverless::GraphQLApi
...
Properties:
  ...
  ApiKeys:
    - Description: Key1
      Expires: 1557768302
    - Description: Key2
    - null # creates a api key without a Description or Expires Date
```
...
#### Graph Api Key Object

Defines a api key for a Serverless GraphQL Api

```yaml
Description: This is a test key
Expires: 1557524411 # Unix Epoch time for the Expiration date of the api key
```
> NOTE: All fields are optional if you are creating a Api Key that has neither a Description or a Expires Property then you can pass **null** instead of this object


#### Graph Log Config Object

Defines the log configuration for a Serverless GraphQL Api
...
RetentionInDays: 3
```
> NOTE: For valid values for FieldLogLevel and RetentionInDays: [click here](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-logconfig.html)
