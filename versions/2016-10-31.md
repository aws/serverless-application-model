...
Valid values for TriggerEvents can be found in the [TriggerConfig API Reference](https://docs.aws.amazon.com/codedeploy/latest/APIReference/API_TriggerConfig.html).
...
DeploymentPreference:
  ...
  TriggerConfigurations:
    ...
    - TriggerEvents:
      ...
      TriggerTargetArn: !Ref MySNSTopic  # SNS Topic must be created in the same template
```
...
Domain:
  ...
  Route53: # optional | Default behavior is to treat as None - does not create Route53 resources | Enable these settings to create Route53 Recordsets
    ...
    DistributionDomainName: String # REQUIRED IF the EndpointConfiguration is EDGE | Domain name of a [cloudfront distribution](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-distribution.html) is required to create Route53 recordsets 
```
