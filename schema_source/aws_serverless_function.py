...
AutoPublishAliasAdditionalProperties = Optional[SamIntrinsicable[bool]]
...
class Properties(BaseModel):
    ...
    AutoPublishAliasAdditionalProperties: Optional[AutoPublishAliasAdditionalProperties]  # TODO: add docs
