...
INPUT_TEMPLATE = "basic_api_inline_openapi.yaml"
TRANSLATED_CFN_TEMPLATE = "cfn_basic_api_inline_openapi.yaml"
EXPECTED_JSON_FILE = "basic_api_inline_openapi.json"
...
class TestBasicFunction(TestCase):
    ...
    def test_basic_function(self):
        ...
        cwd = os.getcwd()
        input_file_path = os.path.join(cwd, 'tests_integ', 'resources', 'templates', 'single', INPUT_TEMPLATE)
        output_file_path = os.path.join(cwd, TRANSLATED_CFN_TEMPLATE)
        expected_resource_path = os.path.join(cwd, 'tests_integ', 'resources', 'expected', 'single', EXPECTED_JSON_FILE)
        ...
        with open(output_file_path, 'r') as cfn_file:
            ...
            self.assertTrue(stack.verify_stack_resources(expected_resource_path, stack_resources))
