...
from integration.config.service_names import API_KEY, COGNITO


@skipIf(current_region_does_not_support([COGNITO, API_KEY]), "Cognito is not supported in this testing region")
