...
class TestFunctionWithApplication(BaseTest):
    def test_function_referencing_outputs_from_application(self):
        ...
        lambda_funciton_name = self.get_physical_id_by_type("AWS::Lambda::Function")
        ...
        function_config = lambda_client.get_function_configuration(FunctionName=lambda_funciton_name)
