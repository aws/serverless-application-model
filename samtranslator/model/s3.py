...
class S3Bucket(Resource):
    ...
    property_types = {
        ...
        "AnalyticsConfigurations": PropertyType(False, is_type(list)),
        ...
        "IntelligentTieringConfigurations": PropertyType(False, is_type(list)),
        "InventoryConfigurations": PropertyType(False, is_type(list)),
        "LifecycleConfiguration": PropertyType(False, any_type()),
        "LoggingConfiguration": PropertyType(False, any_type()),
        "MetricsConfigurations": PropertyType(False, is_type(list)),
        "NotificationConfiguration": PropertyType(False, is_type(dict)),
        "ObjectLockConfiguration": PropertyType(False, is_type(dict)),
        "ObjectLockEnabled": PropertyType(False, is_type(bool)),
