...
from samtranslator.model.apigateway import (ApiGatewayDeployment, ApiGatewayRestApi,
                                            ...
                                            ApiGatewayBasePathMapping, ApiGatewayUsagePlan,
                                            ApiGatewayUsagePlanKey, ApiGatewayApiKey)
...
AuthProperties = namedtuple("_AuthProperties",
                            ["Authorizers", "DefaultAuthorizer", "InvokeRole", "AddDefaultAuthorizerToCorsPreflight",
                             "ApiKeyRequired", "ResourcePolicy", "UsagePlan"])
...
class ApiGenerator(object):
    ...
    def to_cloudformation(self):
        ...
        return rest_api, deployment, stage, permissions, domain, basepath_mapping, usage_plan
    ...
    def _construct_usage_plan(self, rest_api_stage=None):
        ...
        usage_plan_type = usage_plan_properties.get('CreateUsagePlan')
        usage_plan = None
    ...
    def _construct_api_key(self, usage_plan_logical_id, usage_plan_type, rest_api_stage):
        if usage_plan_type == 'SHARED':
    ...
    def _construct_usage_plan_key(self, usage_plan_logical_id, usage_plan_type, api_key):
        if usage_plan_type == 'SHARED':
