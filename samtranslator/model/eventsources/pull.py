...
class MQ(PullEventSource):
    ...
    def policy_name(self) -> str:
        """Generate policy name based on MQ logical ID.
        ...
        policy name should be based on MQ logical ID not to clash with policy ames of other MQ event sources.

        Returns
        -------
            Name of the policy which will be attached to the Lambda Execution role.
        """
        return f"{self.logical_id}AMQPolicy"
