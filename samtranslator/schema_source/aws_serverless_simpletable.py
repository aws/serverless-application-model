...
from samtranslator.schema_source.aws_serverless_connector import EmbeddedConnector
from samtranslator.schema_source.common import BaseModel, PassThroughProp, ResourceAttributes, get_prop
