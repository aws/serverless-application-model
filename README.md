...
This GitHub repository contains the SAM Specifications, the Python code that translates SAM templates into AWS CloudFormation stacks and lots of example applications. 
